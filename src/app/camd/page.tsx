...
const questions: Question[] = [
    {
      question: "Are you currently enrolled in CAMD?",
      correctAnswer: "Yes",
    ...
    {
      question: "Have you successfully completed ARTG 6000?",
      correctAnswer: "Yes",
      advice: "Successfully complete ARTG 6000 to be eligible for co-op.",
    },
    {
      question: "Have you successfully completed ARTG 6040?",
      correctAnswer: "Yes",
      advice: "Successfully complete ARTG 6040 to be eligible for co-op.",
    },
  ];
