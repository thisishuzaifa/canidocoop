...
const questions: Question[] = [
  {
    question: "Are you currently enrolled in Align or MSCS?",
    correctAnswer: "Yes",
    advice: "Enroll in either Align or MSCS to be eligible for co-op.",
  },
  {
  ...
  {
    question: "Have you successfully completed CS 5001?",
    correctAnswer: "Yes",
    advice: "Successfully complete CS 5001 to be eligible for co-op.",
  },
  {
    question: "Have you successfully completed CS 5002?",
    correctAnswer: "Yes",
    advice: "Successfully complete CS 5002 to be eligible for co-op.",
  },
];
